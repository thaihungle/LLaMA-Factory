...
# default param 1-llama (base 1), 2-gpt4 (data) 3-no (ft 1) 4-hermes (base 2) 5-no (ft2) 6-0.1 (eval) 7-1 (epoch) 8-0 (seed) 9-0.1 (eta) 10--1 (alpha)
# python run_mrpo.py tiny ultrafeedback no hermes no 0.1 1 0  0.1 -1
